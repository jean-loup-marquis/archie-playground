...
import { getActivePlaybook, getActivePlaybookId, subscribe as subscribeScope } from "../active-playbook.js?v=104";
import { open as openConfirm } from "../components/confirm-modal.js?v=35";
