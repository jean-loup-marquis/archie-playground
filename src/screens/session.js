...
import { getPosts, addPostDraft, setSubtitleStyle, subscribe as subscribePostsStore } from "../posts-store.js?v=49";
...
import {
  ...
  TOP_POSTS_LIMIT,
} from "../components/top-post-card.js?v=84";
import { getTopPost } from "../top-posts-store.js?v=52";
...
import * as contextBuilder from "../context-builder.js?v=270";
