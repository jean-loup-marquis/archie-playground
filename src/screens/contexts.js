...
function bind(root) {
  root.addEventListener("click", (event) => {
    ...
    if (dupBtn) {
      ...
      if (copy) {
        import("../components/toast.js?v=41").then(({ showToast }) => showToast("Playbook duplicated"));
    ...
    if (delBtn) {
      ...
      if (getContexts().length <= 1) {
        import("../components/toast.js?v=41").then(({ showToast }) =>
      ...
      openConfirmModal({
        ...
        onConfirm: () => {
          ...
          import("../components/toast.js?v=41").then(({ showToast }) => showToast("Playbook deleted"));
        },
      });
      return;
    }
