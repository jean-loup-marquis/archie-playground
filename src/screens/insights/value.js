...
import { valueLedger, winningPosts, periodLabel } from "./insights-model.js?v=5";
import { renderPortfolioTiles, renderTrend, renderFirstRun, figure } from "./parts.js?v=14";
