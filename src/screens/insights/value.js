...
import { valueLedger, winningPosts, periodLabel } from "./insights-model.js?v=4";
import { renderPortfolioTiles, renderTrend, renderFirstRun, figure } from "./parts.js?v=13";
