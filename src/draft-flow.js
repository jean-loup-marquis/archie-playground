...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=111";
import { getIdeas } from "./library.js?v=105";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=103";
