...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=114";
import { getIdeas } from "./library.js?v=108";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=106";
