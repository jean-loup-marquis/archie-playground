...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=109";
import { getIdeas } from "./library.js?v=103";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=101";
