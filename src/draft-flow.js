...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=116";
import { getIdeas } from "./library.js?v=110";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=108";
