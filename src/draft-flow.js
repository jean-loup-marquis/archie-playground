...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=115";
import { getIdeas } from "./library.js?v=109";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=107";
