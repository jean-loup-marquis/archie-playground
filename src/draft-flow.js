...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=112";
import { getIdeas } from "./library.js?v=106";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=104";
