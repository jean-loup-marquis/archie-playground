...
import { init as initObjectiveEditorModal } from "./components/objective-editor-modal.js?v=4";
...
import { renderWelcomeAltRecap } from "./screens/welcome-alt-recap.js?v=474";
import { renderPlaybook } from "./screens/playbook.js?v=488";
