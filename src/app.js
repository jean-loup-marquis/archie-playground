...
import { init as initObjectiveEditorModal } from "./components/objective-editor-modal.js?v=2";
...
import { renderWelcomeAltRecap } from "./screens/welcome-alt-recap.js?v=472";
import { renderPlaybook } from "./screens/playbook.js?v=486";
