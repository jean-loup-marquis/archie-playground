...
import { escapeAttr } from "../utils.js?v=24";
import { getPillarsForPlaybook, linkBrief } from "../pillars-store.js?v=19";
import { getActivePlaybookId, getActivePlaybook } from "../active-playbook.js?v=94";
