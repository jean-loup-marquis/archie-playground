...
import { escapeAttr } from "../utils.js?v=38";
import { getPillarsForPlaybook, linkBrief } from "../pillars-store.js?v=23";
import { getActivePlaybookId, getActivePlaybook } from "../active-playbook.js?v=98";
