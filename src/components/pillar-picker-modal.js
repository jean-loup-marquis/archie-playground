...
import { escapeAttr } from "../utils.js?v=25";
import { getPillarsForPlaybook, linkBrief } from "../pillars-store.js?v=20";
import { getActivePlaybookId, getActivePlaybook } from "../active-playbook.js?v=95";
