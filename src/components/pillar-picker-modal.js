...
import { escapeAttr } from "../utils.js?v=27";
import { getPillarsForPlaybook, linkBrief } from "../pillars-store.js?v=22";
import { getActivePlaybookId, getActivePlaybook } from "../active-playbook.js?v=97";
