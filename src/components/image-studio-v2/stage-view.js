...
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=105";
import { editCanvas } from "./edit-view.js?v=104";
import { compositeOverlays } from "../image-studio/canvas.js?v=16";
