...
import { generateControls } from "./compose-view.js?v=94";
import { actionBar, toolPalette, editCanvas } from "./edit-view.js?v=96";
import { compositeOverlays } from "./canvas.js?v=8";
