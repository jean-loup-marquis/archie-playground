...
import { html, raw, escapeAttr, escapeHtml } from "../utils.js?v=24";
import { requestOpen, notifyClose } from "../modal-coordinator.js?v=24";
import { getPillarById, getPillarTimeline, setPillarFrozen, subscribe } from "../pillars-store.js?v=19";
...
import { getBriefById } from "../briefs-store.js?v=77";
import { renderDiff } from "../text-diff.js?v=4";
