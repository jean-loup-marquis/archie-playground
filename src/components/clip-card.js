...
import { escapeText, escapeAttr } from "../utils.js?v=27";
import { installMoreMenu } from "./more-menu.js?v=7";
import { renderFeedbackThumbs, renderFeedbackPanel } from "./feedback-control.js?v=10";
import { videoForClip } from "../clip-captions.js?v=11";
import { FORMATS } from "../clip-formats.js?v=57";
