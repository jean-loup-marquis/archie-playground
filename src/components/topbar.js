...
import { getPath, navigate } from "../router.js?v=47";
...
} from "./conversation-status-card.js?v=430";
import { getSessionById, updateSession, subscribe as subscribeSessions } from "../sessions-store.js?v=53";
import { open as openRenameModal } from "./rename-modal.js?v=9";
import { subscribe as subscribeContexts } from "../contexts-store.js?v=90";
...
export function initTopbar() {
  ...
  el.addEventListener("click", (event) => {
    ...
    if (event.target.closest("[data-topbar-welcome-alt-exit]")) {
      import("./confirm-modal.js?v=29").then(({ open }) => {
        open({
