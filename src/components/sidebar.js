...
import { open as openBugReportModal } from "./bug-report-modal.js?v=37";
import { open as openFeedbackModal } from "./feedback-modal.js?v=39";
import { open as openConfirmModal } from "./confirm-modal.js?v=35";
import { open as openRenameModal } from "./rename-modal.js?v=15";
import { open as openSearchModal } from "./search-modal.js?v=68";
import { toggle as toggleShortcutLegend } from "./shortcut-legend.js?v=35";
import { renderAdminMenu, applyUserMode, toggleFlag } from "../admin-menu.js?v=33";
import {
  getSessions,
  getSessionById,
  updateSession,
...
} from "../sessions-store.js?v=59";
import { isFlagOn } from "../feature-flags.js?v=43";
import { isNewUser } from "../user-mode.js?v=35";
import { clearSession as clearLibrarySession } from "../library.js?v=112";
import { getContexts, getContextById, subscribe as subscribeContexts } from "../contexts-store.js?v=96";
import { getConnectedConnectors, subscribe as subscribeConnectors } from "../connectors-store.js?v=80";
import { getUnseenCount as getUnseenTopicCount, subscribe as subscribeTopics } from "../topics-store.js?v=48";
import { getPillarsForPlaybook, subscribe as subscribePillars } from "../pillars-store.js?v=29";
import {
  getActivePlaybook,
  getActivePlaybookId,
  setActivePlaybook,
...
import { getLanes, subscribe as subscribeLanes } from "../research-store.js?v=71";
import { countNewForLane, subscribe as subscribeBriefs } from "../briefs-store.js?v=87";
import { closePanel as closeRightPanel } from "./right-panel.js?v=643";
import { clearSession as clearAssistantSession } from "../assistant.js?v=118";
import { clearSession as clearPostsSession } from "../posts-store.js?v=88";
import { clearSession as clearSourcesSession } from "../sources-stream.js?v=110";
...
function deleteSidebarSession(sessionId) {
  ...
  openConfirmModal({
    ...
    onConfirm: () => {
      ...
      import("./toast.js?v=43").then(({ showToast }) => showToast("Chat deleted"));
    },
  });
}
