...
import { getContexts, getContextById, subscribe as subscribeContexts } from "../contexts-store.js?v=53";
...
import { closePanel as closeRightPanel } from "./right-panel.js?v=441";
import { clearSession as clearAssistantSession } from "../assistant.js?v=77";
import { clearSession as clearPostsSession } from "../posts-store.js?v=53";
...
const NAV = [
  ...
  // things — so an identically-styled "Insights 5" was read as five insights
