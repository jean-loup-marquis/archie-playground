...
import { open as openBugReportModal } from "./bug-report-modal.js?v=38";
import { open as openFeedbackModal } from "./feedback-modal.js?v=40";
import { open as openConfirmModal } from "./confirm-modal.js?v=36";
import { open as openRenameModal } from "./rename-modal.js?v=16";
import { open as openSearchModal } from "./search-modal.js?v=69";
import { toggle as toggleShortcutLegend } from "./shortcut-legend.js?v=36";
import { renderAdminMenu, applyUserMode, toggleFlag } from "../admin-menu.js?v=34";
import {
  getSessions,
  getSessionById,
  updateSession,
...
import { getConnectedConnectors, subscribe as subscribeConnectors } from "../connectors-store.js?v=81";
import { getUnseenCount as getUnseenTopicCount, subscribe as subscribeTopics } from "../topics-store.js?v=49";
import { getPillarsForPlaybook, subscribe as subscribePillars } from "../pillars-store.js?v=30";
import {
  getActivePlaybook,
  getActivePlaybookId,
  setActivePlaybook,
  subscribe as subscribeScope,
} from "../active-playbook.js?v=105";
import { getLanes, subscribe as subscribeLanes } from "../research-store.js?v=72";
import { countNewForLane, subscribe as subscribeBriefs } from "../briefs-store.js?v=88";
import { closePanel as closeRightPanel } from "./right-panel.js?v=644";
import { clearSession as clearAssistantSession } from "../assistant.js?v=119";
import { clearSession as clearPostsSession } from "../posts-store.js?v=89";
import { clearSession as clearSourcesSession } from "../sources-stream.js?v=111";
...
function deleteSidebarSession(sessionId) {
  ...
  openConfirmModal({
    ...
    onConfirm: () => {
      ...
      import("./toast.js?v=44").then(({ showToast }) => showToast("Chat deleted"));
    },
  });
}
